...
<main>
    ...
    <section class="py-lg-5 py-4  about-hero">
        <div class="container">
    ...
    <!-- Governance and Independence Section -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <p class="text">
                                    ...
                                    to effectively
                                    defend their consumer rights. All CPB champions' fees directly support our important
                                    work in this area.
                                    As a champion-driven organisation, we rely on individuals who share our vision to
                                    join and support our
                                    cause. Getting involved not only provides you with valuable services but also
                                    contributes to our
                                    broader efforts in consumer advocacy and protection.
                                </p>
                                <p class="text">
                                    If you are interested in learning more about how getting involved can benefit you
                                    and support our
                            ...
                            <!-- Required Acknowledgements Section -->
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-12">
                            <div class="alert alert-info border-start border-4 border-primary" style="background-color: #e7f3ff;">
                                <div class="d-flex align-items-start">
                                    <i class="bi bi-info-circle-fill me-3" style="color: #223a78; font-size: 1.3rem; margin-top: 2px;"></i>
                                    <p class="mb-0" style="font-size: 0.95rem; color: #223a78;">
                                        <strong>Note:</strong> This Charter reflects shared values and does not confer governance or decision-making authority.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-white rounded-3 shadow-sm p-4 p-lg-5">
                                ...
                                <!-- <div class="mt-4 pt-4" style="border-top: 3px solid #e5bf20;">
                                    <div class="alert mb-0" style="background-color: #fff3cd; border: none;">
                                        <div class="d-flex align-items-start">
                                            <i class="bi bi-exclamation-triangle-fill me-3" style="color: #223a78; font-size: 1.3rem; margin-top: 2px;"></i>
                                            <p class="mb-0" style="font-size: 0.95rem; color: #223a78;">
                                                <strong>Important:</strong> These terms are legally binding and clarify that Consumer Champion status does not confer company membership, governance rights, or decision-making authority.
                                            </p>
                                        </div>
                                    </div>
                                </div> -->
                ...
                <div class="col-lg-8 px-0 bg-white order-lg-1 order-2 ">
                    <div class="service-white-card service-card py-lg-5 py-3">
                        ...
                        <p class="text ">
                            ...
                            As a champion, you gain exclusive access to a plethora of benefits, including:
                        </p>
