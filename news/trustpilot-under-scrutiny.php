...
<head>
    <title>Trustpilot’s Alleged Removal of Negative Reviews - Consumer Alert
        News - (CPB)
    </title>
                ...
                <div class="col-lg-10 mx-auto bg-gold p-0">
                    ...
                    <div class="px-lg-5 px-3">
                        <h1 class="news-heading text-uppercase  my-3">
                            <span class="text-lg">TRUSTPILOT UNDER SCRUTINY: </span> <br>
                            <span class="text-alert">CONSUMER PROTECTION BUREAU DEMANDS TRANSPARENCY IN REVIEW
                                PRACTICES</span>
                        </h1>
                        ...
                        <p class="text ">
                            <b>LONDON, March 18, 2025 –</b>
                            The Consumer Protection Bureau (CPB) has issued a formal challenge to Trustpilot regarding
                            the platform's review moderation processes, citing significant concerns about transparency
                            and fairness. Despite multiple engagement attempts dating back to February 2025, Trustpilot
                            has remained unresponsive to requests for clarification, casting doubt on its claims of
                        ...
                        <div class="row mt-4 mb-4">
                            ...
                            <p class="text mt-4">
                                On March 1, 2025, CPB delivered a formal inquiry to Trustpilot's compliance department
                                seeking clarity on allegations that the platform may be engaged in preferential review
                                moderation practices, particularly favouring businesses subscribing to Trustpilot's
                                premium services. The inquiry sought answers to the information:
                            </p>
                            <ol class="ps-4 ms-4">
                                <li>
                                    <p class="text">
                                        What are the exact criteria for removing or moderating a review?
                                    </p>
                                </li>
                                <li>
                                    <p class="text">
                                        Do businesses that subscribe to Trustpilot’s paid services have greater
                                        influence over the moderation process?
                                    </p>
                                </li>
                                <li>
                                    <p class="text">
                                        What safeguards are in place to ensuring legitimate consumer feedback remains
                                        published and are not unfairly removed?
                                    </p>
                                </li>
                                <li>
                                    <p class="text">
                                        Does Trustpilot have protocols for addressing potential conflicts of interest in
                                        review management?
                                    </p>
                                </li>
                            </ol>
                            <div class="col-lg-12">
                                ...
                                <p class="text">
                                    The 15th of March 2025 response deadline has now passed with only a computer
                                    generated acknowledgment from Trustpilot, heightening concerns about the platform's
                                    commitment to maintaining review integrity.
                                </p>
                                <p class="text">
                                    <b><i> "Review platforms serve as critical decision-making tools for today's
                                            consumers,"</i></b>
                                    said Yousouf Jhugroo, Managing Director of the Consumer Protection Bureau.
                                ...
                                <p class="text">
                                    The allegations raise substantial questions about the reliability of Trustpilot's
                                    review ecosystem. If the platform indeed provides preferential treatment to paying
                                    businesses by selectively moderating negative reviews, millions of consumers may be
                                    making purchasing decisions based on artificially inflated ratings.
                                </p>
                                <p class="text">
                                    In response to Trustpilot's continued silence, CPB is evaluating escalation options,
                                    including bringing these concerns to relevant regulatory authorities and consumer
                                    advocacy organisations around the world to ensure appropriate accountability.
                                </p>
                                ...
                                <div class="text shadow-sm rounded-2  p-3 border"
                                    ...
                                    <p class="text">
                                        The CPB calls on Trustpilot to immediately address these allegations with full
                                        transparent answers regarding its moderation protocols. This situation presents
                                        Trustpilot with an opportunity to demonstrate a genuine commitment to the
                                        principles of fairness and transparency it publicly endorses.
                                    </p>
                                    <p class="text">
                                        Consumers who believe their genuine reviews have been inappropriately
                                        removed from Trustpilot are encouraged to document their experiences and contact
                                        CPB at
                                    </p>
                                ...
                                About the Consumer Protection Bureau
                                    ...
                                    <p class="text">
                                    The Consumer Protection Bureau champions consumer rights by promoting fair business practices and corporate accountability. Through advocacy, education, and direct intervention, CPB works to create a marketplace where consumers can make truly informed decisions based on accurate information.                                    </p>
                            </div>
