            ...
            <div class="row">
                <div class="col-lg-10 mx-auto bg-gold p-0">
                    ...
                    <div class="px-lg-5 px-3">
                        ...
                        <p class="text">
                            The penalties include a $114,000 fine on Nazir personally and $15,000 each on his companies
                            HSQ and PL1. These entities were authorised as passive Special Purpose Vehicles (SPVs), yet
                            they blatantly exceeded their scope by actively managing residential properties in the UAE.
                            Adding insult to injury, Nazir submitted a voluntary strike-off application riddled with
