                ...
                <div class="col-lg-6">
                    <div class=" h-100  position-relative overflow-hidden" style="">
                        ...
                        <div class="card-body px-lg-4 py-4 text-center">
                            <div class="card-image-wrapper position-relative mb-4 mx-auto" style="max-width: 370px;">
                                ...
                                <div class="col-lg-12 col-md-8 mb-4">
                                    <div class="friend-card-wrapper text-center">
                                        <div class="card-container">
                                            <img src="assets/images/cpb-friends/Omar-Gouda.png" alt="CPB Friend Card"
                        ...
                        <div class="carousel-item">
                            <div class="row justify-content-center">
                                <div class="col-lg-12 col-md-6 mb-4">
                                    <div class="friend-card-wrapper text-center">
                                        <div class="card-container">
                                            <img src="assets/images/cpb-friends/li-cpb-frnd.png" alt="CPB Friend Card"
                                                class="img-fluid rounded-3  hover-lift">
                                            <div class="mt-3">
        ...
        <div class="container pt-5">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-6 mb-3">
                    <a href="consumer-issues.php" class="text-decoration-none text-dark">
                        <div class="amenity-card">
                            <img src="assets/images/aminities/parking.png"
                                alt="Consumer Protection for Parking Disputes " class="img-fluid">
                ...
                <div class="col-lg-3 col-md-6 col-6 mb-3">
                    <a href="consumer-issues.php" class="text-decoration-none text-dark">
                        <div class="amenity-card">
                            <img src="assets/images/aminities/delivery.png"
                                alt="Consumer Protection for Postal and Parcel Delivery Scams " class="img-fluid">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="faq.php#faq-13" class="faq-text text-decoration-none ">
                                <i class="bi bi-arrow-right-circle-fill me-2"></i> Can I stop being a CPB Consumer
                                Champion
                                ?
                            </a>
                        </li>
