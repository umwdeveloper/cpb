...
<?php include 'assets/include/header.php'; ?>
 <main class="home-main">
                    ...
                    <div class="row h-100 pt-lg-3">
                        <div
                            ...
                            <div>
                                ...
                                <div class="mt-4 pt-4">
                                    <a href="get-help.php" class="main-btn">Contact Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row feature-cards">
                    <div class="col-lg-3 col-md-6 mb-lg-0 mb-3">
                        <div class="feature-cards-card">
                            ...
                            <p class="mb-0 pb-0">
                                We favour products and services that prioritise your safety, ensuring compliance with
                ...
                <div class="row align-items-center py-lg-4">
                    <div class="col-lg-12">
                        ...
                        <p class="text">
                            ...
                            dedicated to empowering consumers and promoting fairness in the 
                            marketplace. We are
                            engage to upholding consumer protection laws and advancing consumer rights in the UK and
                            beyond.
                        </p>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <img src="assets/images/about consumer protection bureau.png"
                            alt="About Conumer Protection Bureau" class="img-fluid ps-lg-4 d-lg-block d-none">
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="friends-cards-carousel">
                    <div class="carousel slide" id="friendsCarousel" data-bs-ride="carousel">
                                    ...
                                    <div class="col-lg-12 col-md-8 mb-4">
                                        <div class="friend-card-wrapper text-center">
                                            <div class="card-container">
                                                <img src="assets/images/cpb-friends/Omar-Gouda.png"
                            ...
                            <div class="carousel-item">
                                <div class="row justify-content-center">
                                    <div class="col-lg-12 col-md-6 mb-4">
                                        <div class="friend-card-wrapper text-center">
                                            <div class="card-container">
                                                <img src="assets/images/cpb-friends/li-cpb-frnd.png"
                                                    alt="CPB Friend Card" class="img-fluid rounded-3  hover-lift">
                                                <div class="mt-3">
                            ...
                            <div class="carousel-item">
                                <div class="row justify-content-center">
                                    <div class="col-lg-12 col-md-6 mb-4">
                                        <div class="friend-card-wrapper text-center">
                                            <div class="card-container">
                                                <img src="assets/images/cpb-friends/george-cpb-frnd.png"
                                                    alt="CPB Friend Card" class="img-fluid rounded-3  hover-lift">
                                                <div class="mt-3">
                            ...
                            <div class="carousel-item">
                                <div class="row justify-content-center">
                                    <div class="col-lg-12 col-md-6 mb-4">
                                        <div class="friend-card-wrapper text-center">
                                            <div class="card-container">
                                                <img src="assets/images/cpb-friends/Michal-cpb-frnd.png"
                                                    alt="CPB Friend Card" class="img-fluid rounded-3  hover-lift">
                                                <div class="mt-3">
                            ...
                            <div class="carousel-item">
                                <div class="row justify-content-center">
                                    <div class="col-lg-12 col-md-6 mb-4">
                                        <div class="friend-card-wrapper text-center">
                                            <div class="card-container">
                                                <img src="assets/images/cpb-friends/Maureen.png" alt="CPB Friend Card"
                        ...
                        <!-- Carousel Controls -->
                        <button class="carousel-control-prev" type="button" data-bs-target="#friendsCarousel"
                            data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#friendsCarousel"
                            data-bs-slide="next">
        ...
        .friend-card-wrapper img {
            ...
            /* Keeps ratio aligned with new max-width */
            object-fit: contain;
            ...
            <div class="container">
                <div class="row justify-content-center pb-5">
                    <div class="col-lg-12 text-center mb-5">
                        <h2 class="main-heading text-uppercase">Become a Consumer Champion of <br> the Consumer
                            Protection Bureau (CPB)
                        </h2>
                        <p class="text mt-3">
                            At CPB, our mission is to protect consumer rights and ensure fair outcomes when companies
                            let
                            you down.
                            By becoming a champion, you'll have our expert support for complaints, refunds, and ongoing
                            consumer protection.
                        </p>
                        ...
                        <div class="how-it-works mt-4 ">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <ul class="list-unstyled">
                                        <li class="mb-3">
                                            <strong>Annual Champion Fee:</strong> £50 per year (Silver Champion)
                                        </li>
                                        <li class="mb-3">
                                            <strong>Refunds:</strong> If we recover more than £300, 
                                            we apply a small
                                            admin
                                            fee (15% for Bronze & Silver champion, reduced to 10% for Gold champions)
                                        </li>
                                        <li class="mb-3">
                                            <strong>Voluntary Contribution:</strong> If you do not wish to become a
                                            champion,
                                            you can still request our help by making a voluntary contribution to support
                                            our
                                            work
                                        </li>
                                    </ul>
                        ...
                        <div class="card h-100 popular">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled">
                                    ...
                                    <li>✓ champions-only webinars and advice sheets</li>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled">
                                    ...
                                    <li>✓ Recognition as a Gold Champion</li>
                    ...
                    <div class="col-lg-8 text-center mt-4">
                        ...
                        <div class="mt-4">
                            <a href="cpb-consumer-champion.php" class="main-btn">Become a Champion Today</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12 mb-lg-5 mb-3">
                        ...
                        <p class="text text-center">
                            As a proud member of the <a href="https://www.compliance-experts.co.uk/" class="fi">CRC
                                Group</a>, we support and promote goods and services that meet with our core values of
                            consumer protection. Our engagments include advocating for consumer rights and ensuring
                            compliance with consumer protection laws.
                        </p>
                    </div>
                    <div
                    ...
                    <div class="col-lg-12 ">
                        <div class="fight-card px-lg-5 home-alert-text">
                            ...
                            <p class="text py-2 text-white  mb-0 pb-0">
                                We are proud to announce that <b>Consumer Protection Bureau</b> is now a <b>member </b>
                                of
                                <b>Consumers International</b>, the leading global voice for consumer rights. This
                                partnership marks a significant step in our commitment to advocating for fair trade,
                                ethical
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-6 mb-3">
                        <a href="consumer-issues.php#consumer-rights" class="text-decoration-none text-dark">
                            <div class="amenity-card">
                                <img src="assets/images/aminities/consumer rights uk.png"
                                    alt="Consumer Rights Protection" class="img-fluid">
                                ...
                                <div class="contact-form">
                                    ...
                                    <form method="post" class="contact-validation-active" id="issue-form"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 mb-3">
                                                ...
                                                <select name="currency" id="currency" class="form-control text-white"
                                                    ...
                                                    <option value="GBP" selected>British Pound Sterling (GBP - £)
                                                    </option>
                                                    <option value="EUR">Euro (EUR - €)</option>
                                                    <option value="USD">US Dollar (USD - $)</option>

                                                    <!-- All other currencies alphabetically -->
                                                    <option value="AED">United Arab Emirates Dirham (AED - د.إ.‏)
                                                    </option>
                                            ...
                                            <div class="col-md-5 mb-3">
                                                ...
                                                <input type="number" name="price" id="price"
                                                    class="form-control form-input" placeholder="Price amount" required
                                                    min="0" step="0.01">
                                        ...
                                        <div class="g-recaptcha"
                                            data-sitekey="6LeWW5YqAAAAAO7CXW7SvpYQih0o9w_XaILDCy3j">
                                        </div>
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <a href="faq.php#faq-6" class="faq-text text-decoration-none ">
                                    <i class="bi bi-arrow-right-circle-fill me-2"></i> How do I become a CPB Consumer
                                    Champion?
                                </a>
                            </li>
                            <li>
                                <a href="faq.php#faq-7" class="faq-text text-decoration-none ">
                                    <i class="bi bi-arrow-right-circle-fill me-2"></i> What kind of complaints can I
                                    bring
                                    to CPB?
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="faq.php#faq-13" class="faq-text text-decoration-none ">
                                    <i class="bi bi-arrow-right-circle-fill me-2"></i> Can I stop being a CPB Consumer Champion
                                    ?
                                </a>
                            </li>
                        </ul>
                ...
                <div class="form-group checkbox-wrapper">
                    <label class="custom-checkbox">
                        ...
                        <span class="checkbox-label">
                            Consent to appear on CPB Offical Website and Social Media Pages.</span>
                    </label>
                </div>
                <button type="submit">
                    <b>Be Ally</b>
        ...
        <div id="successMessage" style="display: none;">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                <g id="freepik--background-complete--inject-71">
                    ...
                    <rect x="171.14" y="389.21" width="46.75" height="0.25" style="fill:#ebebeb"></rect>
                    <rect x="112.8" y="399.65" width="19.19" height="0.25" style="fill:#ebebeb"></rect>
                    <rect x="312.33" y="395.31" width="30.21" height="0.25" style="fill:#ebebeb"></rect>
                    <rect x="351.44" y="395.31" width="19.32" height="0.25" style="fill:#ebebeb"></rect>
                    <rect x="391.35" y="399.53" width="58.56" height="0.25" style="fill:#ebebeb"></rect>
                    <path
                    ...
                    <path
                        ...
                        style="fill:#ebebeb"></path>
                    <rect x="89.51" y="96.33" width="237.93" height="148.89"
                        transform="translate(416.95 341.55) rotate(180)" style="fill:#f0f0f0"></rect>
                    <rect x="141.03" y="56.47" width="134.89" height="228.62"
                        transform="translate(379.25 -37.7) rotate(90)" style="fill:#fafafa"></rect>
                    <polygon points="292.69 238.22 269.23 103.33 251.94 103.33 275.39 238.22 292.69 238.22"
                        style="fill:#fff"></polygon>
                    <polygon points="271.4 238.22 247.95 103.33 240.22 103.33 263.67 238.22 271.4 238.22"
                        style="fill:#fff"></polygon>
                    <polygon points="233.56 238.22 210.11 103.33 192.82 103.33 216.27 238.22 233.56 238.22"
                        style="fill:#fff"></polygon>
                    <polygon points="189.97 238.22 166.51 103.33 158.78 103.33 182.23 238.22 189.97 238.22"
                        style="fill:#fff"></polygon>
                    <rect x="194.68" y="170.19" width="134.89" height="1.18"
                        transform="translate(432.9 -91.35) rotate(90)" style="fill:#e0e0e0"></rect>
                    <rect x="254.75" y="170.19" width="134.89" height="1.18"
                        transform="translate(492.97 -151.41) rotate(90)" style="fill:#e0e0e0"></rect>
                    <rect x="197.6" y="168.45" width="134.89" height="4.66"
                        transform="translate(435.82 -94.27) rotate(90)" style="fill:#f0f0f0"></rect>
                    <rect x="136.96" y="170.19" width="134.89" height="1.18"
                        transform="translate(375.19 -33.63) rotate(90)" style="fill:#e0e0e0"></rect>
                    <rect x="139.88" y="168.45" width="134.89" height="4.66"
                        transform="translate(378.1 -36.55) rotate(90)" style="fill:#f0f0f0"></rect>
                    <rect x="79.22" y="170.19" width="134.89" height="1.18"
                        transform="translate(317.44 24.11) rotate(90)" style="fill:#e0e0e0"></rect>
                    <rect x="82.14" y="168.45" width="134.89" height="4.66"
                        transform="translate(320.36 21.2) rotate(90)" style="fill:#f0f0f0"></rect>
                    <rect x="14.47" y="170.19" width="148.89" height="1.18"
                        transform="translate(259.69 81.86) rotate(90)" style="fill:#e0e0e0"></rect>
                    <path
                    ...
                    <g style="opacity:0.6000000000000001">
                        <rect x="230.73" y="80" width="103.46" height="271.67"
                            transform="translate(564.92 431.67) rotate(180)" style="fill:#f5f5f5"></rect>
                        <polygon points="293.64 353.89 302.31 353.89 299.88 82.22 296 82.22 293.64 353.89"
                            style="fill:#e6e6e6"></polygon>
                        <polygon points="312.77 353.89 316.96 353.89 315.78 82.22 313.91 82.22 312.77 353.89"
                            style="fill:#e6e6e6"></polygon>
                        <polygon points="268.5 353.89 272.68 353.89 271.51 82.22 269.64 82.22 268.5 353.89"
                            style="fill:#e6e6e6"></polygon>
                        <polygon points="247.2 353.89 251.38 353.89 250.21 82.22 248.34 82.22 247.2 353.89"
                            style="fill:#e6e6e6"></polygon>
                    </g>
                    <g style="opacity:0.6000000000000001">
                        <rect x="70.67" y="80" width="51.73" height="271.67"
                            transform="translate(193.07 431.67) rotate(180)" style="fill:#f5f5f5"></rect>
                        <polygon points="102.13 353.89 106.46 353.89 105.25 82.22 103.31 82.22 102.13 353.89"
                            style="fill:#e6e6e6"></polygon>
                        <polygon points="111.69 353.89 113.78 353.89 113.2 82.22 112.26 82.22 111.69 353.89"
                            style="fill:#e6e6e6"></polygon>
                        <polygon points="89.56 353.89 91.65 353.89 91.06 82.22 90.13 82.22 89.56 353.89"
                            style="fill:#e6e6e6"></polygon>
                        <polygon points="78.91 353.89 81 353.89 80.41 82.22 79.47 82.22 78.91 353.89"
                            style="fill:#e6e6e6"></polygon>
                    </g>
                    <rect x="361.1" y="122" width="68.63" height="85.66" style="fill:#e6e6e6"></rect>
                    <rect x="362.13" y="122" width="70.62" height="85.66" style="fill:#f5f5f5"></rect>
                    <rect x="360.69" y="134.93" width="73.5" height="59.79"
                        transform="translate(562.27 -232.61) rotate(90)" style="fill:#fafafa"></rect>
                    <rect x="390.31" y="164.55" width="73.5" height="0.56"
                        transform="translate(591.89 -262.23) rotate(90)" style="fill:#e6e6e6"></rect>
                    <circle cx="411.12" cy="153.89" r="8.64" transform="translate(11.59 335.78) rotate(-45)"
                        style="fill:#f0f0f0"></circle>
                    <circle cx="397.31" cy="166.85" r="17.56" transform="translate(-1.61 329.81) rotate(-45)"
                        style="fill:#fff"></circle>
                    <circle cx="384.35" cy="153.89" r="8.64" transform="translate(146.27 492.6) rotate(-76.72)"
                        style="fill:#f0f0f0"></circle>
                    <rect x="349.68" y="280.36" width="9.38" height="95.62" style="fill:#f0f0f0"></rect>
                    <rect x="347.4" y="274.64" width="99.82" height="5.72" style="fill:#f0f0f0"></rect>
                    <rect x="353.5" y="375.98" width="87.61" height="6.42" style="fill:#f0f0f0"></rect>
                    <rect x="359.06" y="280.36" width="85.88" height="95.62" style="fill:#fafafa"></rect>
                    <rect x="366.88" y="291.01" width="70.23" height="29.34"
                        transform="translate(803.99 611.36) rotate(180)" style="fill:#f0f0f0"></rect>
                    <rect x="366.88" y="334.17" width="70.23" height="29.34"
                        transform="translate(803.99 697.67) rotate(180)" style="fill:#f0f0f0"></rect>
                    <rect x="392.17" y="289.28" width="19.65" height="4.56" rx="1.82" style="fill:#fafafa"></rect>
                    <rect x="392.17" y="332.44" width="19.65" height="4.56" rx="1.82" style="fill:#fafafa"></rect>
                    <circle cx="188.1" cy="360.84" r="21.56" transform="translate(-55.37 34.79) rotate(-9.22)"
                        style="fill:#ebebeb"></circle>
                    <circle cx="154.98" cy="355.49" r="26.91" transform="translate(-54.94 29.42) rotate(-9.22)"
                ...
                <g id="freepik--character-1--inject-71">
                    ...
                    <path d="M252.46,127.29l1.7-6.11-6.75.52s-.48,4,1.85,6.41Z" style="fill:#7f3e3b"></path>
                    <polygon points="255.17 114.07 249.01 115.68 247.41 121.7 254.16 121.18 255.17 114.07"
                    ...
                    <path
                        ...
                        style="fill:#223A78"></path>
                    <polygon points="177.74 353.69 183.13 359.61 198.6 348.59 193.21 342.67 177.74 353.69"
                        style="fill:#7f3e3b"></polygon>
                    <polygon points="147.32 377.08 154.55 380.67 165.18 365.08 157.95 361.49 147.32 377.08"
                        style="fill:#7f3e3b"></polygon>
                    <path
                    ...
                    <path
                        ...
                        style="fill:#263238"></path>
                    <polygon points="198.59 348.59 190.62 354.27 184.59 348.81 193.2 342.67 198.59 348.59"
                        style="opacity:0.2"></polygon>
                    <polygon points="157.95 361.49 165.18 365.08 159.69 373.12 152.46 369.52 157.95 361.49"
                        style="opacity:0.2"></polygon>
                    <path
                    ...
                    <path
                        ...
                        style="fill:#7f3e3b"></path>
                    <path d="M189.34,129.92c5.69,3.5.82,24.09-8.81,23S180.93,124.75,189.34,129.92Z"
                        style="fill:#263238"></path>
                    <path d="M189.13,130c-4.29,2.85-1.36,7.81,13.1,4.87C202.23,134.86,196.25,125.26,189.13,130Z"
                        style="fill:#263238"></path>
                    <path
                    ...
                    <path
                        ...
                        style="opacity:0.2"></path>
                    <polygon points="183.39 343.96 195.38 356.33 200.5 353.5 187.83 339.71 183.39 343.96"
                        style="fill:#223A78"></polygon>
                    <path
                        ...
                        style="fill:#263238"></path>
                    <polygon points="152 366.79 163.37 372.37 167.1 367.74 153.8 361.47 152 366.79"
                        style="fill:#223A78"></polygon>
                    <path
                    ...
                    <path
                        ...
                        style="fill:#263238"></path>
                    <path d="M193.36,143.2c-.48.16-.68.88-.44,1.62l1.75-.56C194.43,143.52,193.84,143,193.36,143.2Z"
                        style="fill:#263238"></path>
                    <path d="M201,140.78c-.49.16-.69.89-.45,1.63l1.76-.57C202,141.1,201.43,140.63,201,140.78Z"
                        style="fill:#263238"></path>
                    <path d="M200.75,140.89l1.61-1.08S201.9,141.49,200.75,140.89Z" style="fill:#263238"></path>
                    <path d="M199,143.8a17.3,17.3,0,0,0,3.48,3.24,2.79,2.79,0,0,1-2.07,1.13Z" style="fill:#630f0f">
                    </path>
                    <path
                    ...
                    <path d="M153.67,132.05l-1.25-8,8.16,4a7.07,7.07,0,0,1-2,3.53,3.3,3.3,0,0,1-3.37,1Z"
                        style="fill:#7f3e3b"></path>
                    <polygon points="157 120.13 161.18 123.8 160.58 128 152.42 124.04 157 120.13" style="fill:#7f3e3b">
                    </polygon>
                    <path
                    ...
                    <path
                        ...
                        style="fill:#223A78"></path>
                    <path d="M193.16,143.31l1.61-1.09S194.31,143.91,193.16,143.31Z" style="fill:#263238"></path>
                </g>
                <g id="freepik--character-2--inject-71">
                    <polygon points="323.89 405.27 316.14 405.28 314.05 387.34 321.8 387.33 323.89 405.27"
                        style="fill:#ffc3bd"></polygon>
                    <polygon points="390.6 371.97 384.73 377.04 371.44 364.81 377.3 359.74 390.6 371.97"
                        style="fill:#ffc3bd"></polygon>
                    <path
                    ...
                    <path
                        ...
                        style="fill:#263238"></path>
                    <path d="M258.89,126.87l.55-9.87-8.2,2.63s-1.91,7.07,3.41,8.93Z" style="fill:#ffc3bd"></path>
                    <polygon points="258.45 111.69 251.68 114.51 251.24 119.63 259.44 117 258.45 111.69"
                        style="fill:#ffc3bd"></polygon>
                    <polygon points="314.06 387.34 315.13 396.59 322.88 396.58 321.81 387.33 314.06 387.34"
                        style="opacity:0.2"></polygon>
                    <polygon points="377.31 359.74 371.44 364.81 378.3 371.11 384.16 366.04 377.31 359.74"
                        style="opacity:0.2"></polygon>
                    <path
                    ...
                    <path
                        ...
                        style="opacity:0.2"></path>
                    <path d="M296.25,127.93c-2.47,4.3-.89,10.42-.89,10.42a4.43,4.43,0,0,0,4.49.2l-.7-11.4Z"
                        style="fill:#263238"></path>
                    <path
                    ...
                    <path
                        ...
                        style="fill:#223A78"></path>
                    <polygon points="305.29 123.14 307.42 119.33 323.88 130.21 320.7 133.83 305.29 123.14"
                        style="fill:#223A78"></polygon>
                    <polygon points="305.29 123.14 307.42 119.33 323.88 130.21 320.7 133.83 305.29 123.14"
                    ...
                    <path
                        ...
                        style="fill:#223A78"></path>
                    <polygon points="373.33 373.44 385.98 362.51 382.71 358.74 368.36 370.71 373.33 373.44"
                        style="fill:#263238"></polygon>
                    <polygon points="310.57 395.11 326.21 395.09 326.2 390.04 308.73 389.8 310.57 395.11"
                        style="fill:#263238"></polygon>
                    <path d="M304.2,137.39c-.5-.15-1.09.33-1.33,1.08l1.78.57C304.89,138.29,304.69,137.55,304.2,137.39Z"
                        style="fill:#263238"></path>
                    <path d="M296.4,135.92c-.51,0-1,.58-1,1.37l1.86.12C297.29,136.62,296.92,136,296.4,135.92Z"
                        style="fill:#263238"></path>
                    <path d="M299.09,138.2a22.47,22.47,0,0,1-3.93,4.7A3.62,3.62,0,0,0,298,144Z" style="fill:#ed847e">
                    </path>
                    <path
                    ...
                    <path
                        ...
                        style="fill:#223A78"></path>
                    <path d="M328.55,211.54l-7.46,2.36,5.79,5.76s6.76-2.93,4.64-5.91Z" style="fill:#ffc3bd"></path>
                    <polygon points="318.02 220.48 323.33 223.7 326.88 219.66 321.09 213.9 318.02 220.48"
                        style="fill:#ffc3bd"></polygon>
                </g>
            </svg>
            <div class="popup-buttons">
