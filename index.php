                                    ...
                                    <div class="me-3">
                                        <div class="do-icon">
                                            <img src="assets/images/consumer-protection.png"
                                                alt="Consumer protection icon" class="about-icon">
                                        </div>
                                    </div>
                                    <p class="text">
                ...
                <div class="row justify-content-center align-items-start">
                    ...
                    <div
                        ...
                        <div class="commitment-icon">
                            <img src="assets/images/honesty.png" alt="Honesty icon">
                        </div>
                        <div>
                    ...
                    <div
                        class="col-lg-2 col-md-4 col-6 mb-3 d-flex flex-column justify-content-center align-items-center">
                        <div class="commitment-icon">
                            <img src="assets/images/shield.png" alt="Quality icon">
                        </div>
                        <div>
                    ...
                    <div
                        class="col-lg-2 col-md-4 col-6 mb-3 d-flex flex-column justify-content-center align-items-center">
                        <div class="commitment-icon">
                            <img src="assets/images/fairness.png" alt="Fairness icon">
                        </div>
                        <div>
                    ...
                    <div
                        class="col-lg-2 col-md-4 col-6 mb-3 d-flex flex-column justify-content-center align-items-center">
                        <div class="commitment-icon">
                            <img src="assets/images/reliability.png" alt="Reliability icon">
                        </div>
                        <div>
                    ...
                    <div class="row ">
                        <div class="col-lg-5 col-md-12">
                            <div class="contact-text">
                                ...
                                <br>
                                <img src="assets/images/Internship-amico.png" alt="Help form"
