            ...
            <div class="row">
                <div class="col-lg-12  py-2">
                    <div
                        ...
                        <div
                            class="d-flex align-items-center contact-details">
                        ...
                        <div class="text-white social-icon">
                            <!-- Facebook -->
                            <a data-mdb-ripple-init target="_blank"
        ...
        <nav class="navbar navbar-expand-xl navbar-light ">
            <div class="container menu-header-container">
                <a class="navbar-brand" href="index.php">
                    <img src="assets/images/Logo - Source File.png" alt
                        class="img-fluid ">
                </a>
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade"
            ...
            <div class="carousel-inner ">
                <div class="carousel-item ">
                    <img src="assets/images/Group 1000004718 (5).png"
                        class=" w-100 d-lg-block d-none" alt="Banner-1">
                    <img src="assets/images/iMAGE+1-1920w.webp"
                        class=" w-100 d-lg-none d-block" alt="banner-2">
                </div>
                <div class="carousel-item carousel-item2 active">
                    <img src="assets/images/photo+2-96f6f8ca-1920w.webp"
                ...
                <div class="row feature-cards">
                    <div class="col-lg-3 col-md-6 mb-lg-0 mb-3">
                        <div class="feature-cards-card">
                            <div class="icon">
                                <img src="assets/images/Secure data-bro.png"
                                    alt class="img-fluid">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-lg-0 mb-3">
                        <div class="feature-cards-card">
                            <div class="icon">
                                <img
                                    src="assets/images/Money stress-rafiki.png"
                                    alt class="img-fluid">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-lg-0 mb-3">
                        <div class="feature-cards-card">
                            <div class="icon">
                                <img src="assets/images/Law firm-amico.png"
                                    alt class="img-fluid">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-lg-0 mb-3">
                        <div class="feature-cards-card">
                            <div class="icon">
                                <img
                                    src="assets/images/Environmental audit-pana.png"
                                    alt class="img-fluid">
                            </div>
            ...
            <div class="container pt-lg-5 pt-3 pb-5">
                <div class="row align-items-center py-lg-4">
                    <div class="col-lg-12">
                        ...
                        <p class="text">
                            <b>Who We Are:</b>
                            The Consumer Protection Bureau (CPB) is an independent, non-governmental organisation dedicated to empowering consumers and promoting fairness in the marketplace.
                        </p>
                    </div>
                    <div class="col-lg-6">
                            ...
                            <li>
                                <div class="d-flex align-items-start">
                                    ...
                                    <p class="text">
                                        ...
                                        We work to ensure fair business practices and protect consumers' financial well-being.
                            ...
                            <li>
                                <div class="d-flex align-items-start">
                                    ...
                                    <p class="text">
                                        ...
                                        When things go wrong, we assist consumers in finding solutions and seeking appropriate compensation.
            ...
            <div class="container">
                <div class="row justify-content-center align-items-start">
                    <div class="col-lg-12 mb-lg-5 mb-3">
                        <h1
                            class="main-heading text-center text-uppercase  mt-2">
                            Our Commitment
                        </h1>
                        <p class="text text-center">
                            As a proud member of the <a href="https://www.compliance-experts.co.uk/" class="fi">CRC Group</a>, we support and promote goods and services that meet with our core values:
                        </p>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-4 col-6 mb-3 d-flex flex-column justify-content-center align-items-center">
                        <div class="commitment-icon">
                            <img
                                src="assets/images/fairness.png"
                                alt class="">
                    ...
                    <div class="col-lg-12 mt-4">
                        <p class="text text-center">
                            Through education, advocacy, and direct assistance, we strive to create a marketplace where consumers are informed, respected, and protected.
                        </p>
                    </div>
        ...
        <section class="py-lg-5 py-4 bg-light">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h1
                            class="main-heading text-center text-uppercase mb-lg-5 mb-3 mt-2">
                    ...
                    <div class="col-lg-3 col-md-6 col-6 mb-3">
                        <a href="consumer-issues.php#online-shopping" class="text-decoration-none text-dark">
                            <div class="amenity-card">
                                <img
                                    src="assets/images/aminities/Online shopping-amico.png"
                                    alt class="img-fluid">
                    ...
                    <div class="col-lg-3 col-md-6 col-6 mb-3">
                        <a href="consumer-issues.php#tips-for-buy-vehical" class="text-decoration-none text-dark">
                            <div class="amenity-card">
                                <img
                                    src="assets/images/aminities/Vehicle Sale-pana.png"
                                    alt class="img-fluid">
                    ...
                    <div class="col-lg-3 col-md-6 col-6 mb-3">
                        <a href="consumer-issues.php#property-renovation-and-repair" class="text-decoration-none text-dark">
                            <div class="amenity-card">
                                <img
                                    src="assets/images/aminities/Build your home-amico (1).png"
                                    alt class="img-fluid">
                    ...
                    <div class="col-lg-3 col-md-6 col-6 mb-3">
                        <a href="consumer-issues.php#faulty-products" class="text-decoration-none text-dark">
                            <div class="amenity-card">
                                <img
                                    src="assets/images/aminities/Product iteration-amico.png"
                                    alt class="img-fluid">
                    ...
                    <div class="col-lg-3 col-md-6 col-6 mb-3">
                        <a href="consumer-issues.php#loans-debt-rights" class="text-decoration-none text-dark">
                            <div class="amenity-card">
                                <img
                                    src="assets/images/aminities/Money stress-amico.png"
                                    alt class="img-fluid">
                    ...
                    <div class="col-lg-3 col-md-6 col-6 mb-3">
                        <a href="consumer-issues.php#consumer-rights" class="text-decoration-none text-dark">
                            <div class="amenity-card">
                                <img
                                    src="assets/images/aminities/Justice-amico.png"
                                    alt class="img-fluid">
                    ...
                    <div class="col-lg-3 col-md-6 col-6 mb-3">
                        <a href="consumer-issues.php#repair-replace-refund" class="text-decoration-none text-dark">
                            <div class="amenity-card">
                                <img
                                    src="assets/images/aminities/Refund-amico.png"
                                    alt class="img-fluid">
                    ...
                    <div class="col-lg-3 col-md-6 col-6 mb-3">
                        <a href="consumer-issues.php#scam-safe" class="text-decoration-none text-dark">
                            <div class="amenity-card">
                                <img
                                    src="assets/images/aminities/Scared-pana.png"
                                    alt class="img-fluid">
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="contact-text">
                                ...
                                <span class="date">COMPLETE OUR SHORT
                                    ...
                                    QUOTE:</span>
                                <br> <img
                                    src="assets/images/Internship-amico.png"
                                    alt class="help-form mt-4 mb-lg-0 mb-4">
                            </div>
                        </div>
                            ...
                            <div class="contact-content ps-lg-5">
                                <div class="contact-form">
                                    ...
                                    <form method="post"
                                        ...
                                        <div>
                                            <label for="complaint-about" class="text-white">Product or Service Complaining about</label>
                                            <input type="text" name="complaint-about"
                                                id="complaint-about"
                                                class="form-control"
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="contact-text">
                                ...
                                <p class>We’d love to hear from you.
                                    ...
                                    <b>Just choose the most convenient method and we’ll get back to you as soon as we can.</b>
