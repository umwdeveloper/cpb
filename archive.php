...
<head>
 ...
 <meta name="description" content="The archive of past cases, updates, and consumer complaints handled by the Consumer Protection Bureau. ">
            ...
            <div class="row justify-content-center align-items-start">
                <div class="col-lg-10 mx-auto ">
                    ...
                    <p class="text-md text-center">
                        Explore our archives to find valuable PDFs on various consumer rights, consumer protection
                        laws, and fair business practices. These resources offer detailed information and insights,
                        empowering you to protect your consumer rights and navigate the marketplace confidently.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row mb-lg-0 mb-4">
                <div class="col-lg-12 ">
                    <div class="bg-white service-card py-3 px-4 shadow rounded-2">
                        ...
                        <iframe src="assets/PDFs/CONSO-JAN 12.pdf" frameborder="0" width="100%" height="500px"></iframe>
                    </div>
                </div>
