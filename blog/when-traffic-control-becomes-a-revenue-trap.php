...
<head>
    ...
    <link rel="canonical" href="https://www.consumerprotectionbureau.co.uk/blog/free-trial-subscription-traps.php">
    ...
    <section class="py-lg-5 py-4 bg-light about-hero">
        <div class="container py-5 px-3 px-md-5" style="max-width: 980px; background: #E3F2FD; border-radius: 12px;">
            ...
            <div class="mb-4 rounded shadow-sm overflow-hidden">
                <img src="../assets/images/blog/yellow-box.png" alt="Yellow Box Junctions Revenue Trap"
            ...
            <div class="mb-4">
                ...
                <p class="text-muted mt-2 small mb-0 pb-0">Published by the <strong>Consumer Protection Bureau
                        (CPB)</strong> | 23 January 2026</p>
            </div>
            <!-- Main Blog Content -->
            <div>
                <p class="fw-medium ">Yellow box junctions were created to serve a clear and sensible purpose: to
                    prevent vehicles from blocking key intersections and to keep traffic flowing.</p>
                <p class="text">Yet across the UK, growing evidence suggests that many yellow box junctions are no
                    longer being used primarily as traffic-management tools, but as highly efficient revenue mechanisms,
                ...
                <div class="p-3 rounded mt-4"
                    ...
                    <p class="text">In practice, this discretion has increasingly been exercised in favour of
                        enforcement rather than fairness.</p>
                </div>
                ...
                <div class="p-3 rounded mt-4"
                    ...
                    <p>Motorists may enter lawfully, only to be penalised seconds later when traffic ahead unexpectedly
                        slows — a factor entirely outside their control.</p>
                    <p>This is not about reckless driving.<br>It is about design-led enforcement.</p>
                </div>
                ...
                <div class="p-3 rounded mt-4"
                    ...
                    <p>Using ambiguously defined road markings and oversized layouts to maximise penalties raises
                        serious concerns about fairness, accountability, and trust.</p>
                ...
                <div id="cpb-position" class="p-4 rounded mt-4"
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="mb-2" style="color:rgba(255,255,255,0.95);">The Consumer Protection Bureau works
                                to expose unfair enforcement practices and advocate for proportionate, transparent, and
                                accountable traffic management.</p>
                            <p class="mb-2" style="color:rgba(255,255,255,0.95);">If you have been affected by yellow
                                box enforcement, CPB encourages you to share your experience and seek advice.</p>
